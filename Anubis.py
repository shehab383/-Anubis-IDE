...
text2 = QTextEdit
type=".py"
python_coloring=Python_Coloring
#
#
#
#
...
class text_widget(QWidget):
    ...
    def itUI(self):
        global text
        text = QTextEdit()
        global python_coloring
        python_coloring = Python_Coloring.PythonHighlighter(text,type)
...
class Widget(QWidget):
    ...
    def on_clicked(self, index):
        ...
        #check if it is cs or py
       # print(nn[-3:])
        global type
        type=nn[-3:]
        python_coloring.setType(type)
        print("type from Anubis: "+ type)
